...
public class CurrencyConverter extends javax.swing.JFrame {
    ...
    double US_Dollar = 82.92;
    double Indian_Rupee = 0.012;
    double Brazilian_Real = 0.060;
    double Canadian_Dollar = 61.07;
    double Kenyan_Shilling = 0.57;
    double Indonesian_Rupiah = 0.0053;
    double Nigerian_Naira = 0.055;
    double Philippine_Peso = 1.48;
    double Pakistani_Rupee = 0.30;
